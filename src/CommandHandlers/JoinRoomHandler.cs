...
class JoinRoomHandler : CommandHandler
{
    public override Task Handle(Client client, NetworkObject receivedObject)
    {
        ...
        if (Configuration.ServerConfiguration.Authentication != false && Configuration.ServerConfiguration.ApiUrl != null) locationSetResponse = httpClient.PostAsync($"{Configuration.ServerConfiguration.ApiUrl}/MMO/SetBuddyLocation", locationSetRequest).Result;
