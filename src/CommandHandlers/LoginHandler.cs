    ...
    private bool ValidToken(Client client) {
        ...
        try {
            ...
            if (info.Authenticated) {
                ...
                if (Configuration.ServerConfiguration.Authentication != false && Configuration.ServerConfiguration.ApiUrl != null) onlineSetResponse = httpClient.PostAsync($"{Configuration.ServerConfiguration.ApiUrl}/MMO/SetBuddyOnline", onlineSetRequest).Result;
                if (onlineSetResponse != null) onlineResString = onlineSetResponse.Content.ReadAsStringAsync().Result;
